...
;// CONCATENATED MODULE: ./src/popup/components/Container/styles.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const styles_module = ({"container":"hTjWAPKKOGmumZ5O62y0WA=="});
;// CONCATENATED MODULE: ./src/popup/components/Container/index.tsx


function Container(props) {
    return react.createElement("div", { className: styles_module.container }, props.children);
}
...
;// CONCATENATED MODULE: ./src/popup/components/Button/styles.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const Button_styles_module = ({"button":"P5+qVGW4rbp8vvNnV9Zc0w=="});
;// CONCATENATED MODULE: ./src/popup/components/Button/index.tsx


function Button(props) {
    return (react.createElement("div", { className: Button_styles_module.button, onClick: props.onClick }, props.children));
}

;// CONCATENATED MODULE: ./src/popup/components/ClearButton/index.tsx
...
function ClearButton() {
    ...
    return react.createElement(Button, { onClick: clearPasses }, "Clear All Passes");
}

;// CONCATENATED MODULE: ./src/popup/components/PassButton/styles.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const PassButton_styles_module = ({"button":"DJAUenJobUI64J9wFNl7kg==","content":"uROaVB4HAmzeh7gzWgEwrQ==","value":"yFGtTKzQ0OtrsL-3LBcnoA=="});
;// CONCATENATED MODULE: ./src/popup/components/PassButton/index.tsx
...
function PassButton(props) {
    ...
    return (react.createElement("div", { className: PassButton_styles_module.button, onClick: props.onClick, onMouseEnter: onEnter, onMouseLeave: onLeave },
        react.createElement("div", { className: PassButton_styles_module.content }, element),
        react.createElement("div", { className: PassButton_styles_module.value }, props.value)));
}

;// CONCATENATED MODULE: ./src/popup/components/CloudflareButton/index.tsx



function CloudflareButton() {
    ...
    return (react.createElement(PassButton, { value: tokens.length, onClick: openHomePage }, "Cloudflare"));
}

;// CONCATENATED MODULE: ./src/popup/components/GithubButton/index.tsx
...
function GithubButton() {
    ...
    return react.createElement(Button, { onClick: openGithub }, "View on Github");
}

;// CONCATENATED MODULE: ./public/images/gold-badge.svg
/* harmony default export */ const gold_badge = (__webpack_require__.p + "47a1591dea3b6d1f42f9b3cd0673f69c.svg");
;// CONCATENATED MODULE: ./package.json
const package_namespaceObject = {"i8":"3.0.3"};
;// CONCATENATED MODULE: ./src/popup/components/Header/styles.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const Header_styles_module = ({"badge":"Gps4A+GAhP1nQhCo2FqmUw==","version":"tre938PME6Wy4N9VsiuemQ==","header":"OO01ijL9cRK+rSJ0RJsaFQ==","detail":"UilEsFzre6qTtYuzahL+Yg==","title":"mwCbv4iW783fYszk10o5nw=="});
;// CONCATENATED MODULE: ./src/popup/components/Header/index.tsx




function Header() {
    return (react.createElement("div", { className: Header_styles_module.header },
        react.createElement("img", { className: Header_styles_module.badge, src: gold_badge }),
        react.createElement("div", { className: Header_styles_module.detail },
            react.createElement("div", { className: Header_styles_module.title }, "Privacy Pass"),
            react.createElement("div", { className: Header_styles_module.version },
                "Version ",
                package_namespaceObject.i8))));
}

;// CONCATENATED MODULE: ./src/popup/components/App/styles.module.scss
// extracted by mini-css-extract-plugin
/* harmony default export */ const App_styles_module = ({"app":"gI1iEx+4jq1aR-L-w8rnSQ=="});
;// CONCATENATED MODULE: ./src/popup/components/App/index.tsx
...
function App() {
    return (react.createElement("div", { className: App_styles_module.app },
        react.createElement(Header, null),
        react.createElement(Container, null,
            react.createElement(CloudflareButton, null),
...
;// CONCATENATED MODULE: ./src/popup/store.ts
...
react_dom.render(react.createElement(components_Provider, { store: store },
